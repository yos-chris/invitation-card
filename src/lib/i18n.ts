...
const en: Dict = {
  ...
  heroTitleLine2: "Bali Customer Relation Office",
  ...
  rsvpIntro: "Please confirm your attendance so we can welcome you properly.",
  fieldName: "Name",
  ...
  share: "Share",
  shareTitle: "1st Anniversary · Bali Customer Relation Office",
  shareText: "You are warmly invited to the 1st Anniversary of the Bali Customer Relation Office — Modern Cancer Hospital Guangzhou.",
...
const id: Dict = {
  ...
  share: "Bagikan",
  shareTitle: "Ulang Tahun Pertama · Bali Customer Relation Office",
  shareText: "Anda diundang hangat ke perayaan Ulang Tahun Pertama Bali Customer Relation Office — Modern Cancer Hospital Guangzhou.",
...
const zh: Dict = {
  ...
  addToCalendar: "添加到日历",
  share: "分享",
  shareTitle: "一周年纪念 · 巴厘岛服务中心",
  shareText: "诚挚邀请您出席巴厘岛服务中心一周年纪念庆典 — 广州现代肿瘤医院。",
  linkCopied: "链接已复制",
  copyLink: "复制链接",
  switchLang: "语言",
  galleryCaption1: "庆典",
